...
const GameCard: React.FC<GameCardProps> = ({ game, onClick }) => {
    ...
    return (
        <div 
            className="bg-gray-800 bg-opacity-90 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-102 active:scale-98 cursor-pointer"
        ...
        >
            <div className="relative">
                ...
                <button
                    ...
                    style={{ minHeight: '36px', minWidth: '36px' }} // Ensuring minimum touch target size
                >
                    <svg 
            ...
            <div className="p-3 sm:p-4">
                <h3 className="text-base sm:text-lg font-semibold text-white mb-1 truncate">{game.name}</h3>
